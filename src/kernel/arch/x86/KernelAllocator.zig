...
const AllocInfo = struct { base: u64, len: u64 };
...
fn alloc(allocator: *Allocator, len: usize, ptrAlign: u29, lenAlign: u29, retAddr: usize) error{OutOfMemory}![]u8 {
    if (ptrAlign > 4096) {
...
fn resize(allocator: *Allocator, buf: []u8, bufAlign: u29, newLen: usize, lenAlign: u29, returnAddress: usize) Allocator.Error!usize {
    const addr: u64 = 0;
